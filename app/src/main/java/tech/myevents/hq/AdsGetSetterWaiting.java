...
class AdsGetSetterWaiting {
        ...
        AdsGetSetterWaiting(int id, int adId, int views, int likes, String interestCode, String brandName,
                            ...
                            String video, String when, String confCOde, String broadcastCharge, String status) {
