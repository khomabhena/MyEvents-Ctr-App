...
public class LogoView extends AppCompatActivity {
    ...
    String posterPath = "sdcard/MyEvents/Ads/MyEvents Posters/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File imageFile = new File("sdcard/MyEvents/Ads/MyEvents Posters/" + bitmapName + ".JPEG");
    ...
    private void getBitmap(final String bitmap_name) {
        String bitmapUrl = App.AppInfo.BITMAP_URL_ADS + bitmap_name;
